...
Opens VS Code web in Chrome with DevTools. For org credentials and settings injection, see [docs/QA.md](https://github.com/forcedotcom/salesforcedx-vscode/blob/HEAD/../../docs/QA.md).
...
**Port conflicts, polyfills, auth:** See [docs/QA.md](https://github.com/forcedotcom/salesforcedx-vscode/blob/HEAD/../../docs/QA.md), [docs/Build.md](https://github.com/forcedotcom/salesforcedx-vscode/blob/HEAD/../../docs/Build.md), [contributing/developing.md](https://github.com/forcedotcom/salesforcedx-vscode/blob/HEAD/../../contributing/developing.md).
