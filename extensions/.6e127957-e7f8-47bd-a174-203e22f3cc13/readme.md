...
**TypeScript Support:** This extension fully supports creating and developing Lightning Web Components using TypeScript. See the [TypeScript LWC Support Guide](https://github.com/forcedotcom/salesforcedx-vscode/blob/HEAD/../../docs/TYPESCRIPT_LWC_SUPPORT.md) for details.
