    ...
    testCases: (0, kit_1.ensureArray)(data.testCase).map((tc) => {
        ...
        return {
            ...
            ...(tc.inputs.conversationHistory && {
                conversationHistory: (0, kit_1.ensureArray)(tc.inputs.conversationHistory).map((ch) => ch.role === 'agent'
    ...
    testCase: spec.testCases.map((tc) => ({
        ...
        inputs: {
            ...
            ...(tc.conversationHistory && {
                conversationHistory: tc.conversationHistory.map((ch, index) => ch.role === 'agent'
...
const parseAgentTestXml = async (mdPath) => {
    ...
    const parser = new fast_xml_parser_1.XMLParser({
        ...
        attributeNamePrefix: '$',
        isArray: (name) => name === 'testCase' || name === 'expectation' || name === 'contextVariable' || name === 'conversationHistory',
