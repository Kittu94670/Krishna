...
<AiAuthoringBundle xmlns="http://soap.sforce.com/2006/04/metadata">
  <bundleType>AGENT</bundleType>
    ...
    async getTrace(planId) {
        return (0, utils_1.requestWithEndpointFallback)(this.connection, {
            method: 'GET',
    ...
    async compile() {
        ...
        try {
            const response = await (0, utils_1.requestWithEndpointFallback)(this.connection, {
                method: 'POST',
                url,
                headers,
    ...
    async publish(skipMetadataRetrieve) {
        ...
        const publisher = new scriptAgentPublisher_1.ScriptAgentPublisher(this.connection, this.options.project, this.agentJson, skipMetadataRetrieve);
    ...
    async startPreview(mockMode, apexDebugging) {
        ...
        try {
            ...
            let response;
            try {
                response = await (0, utils_1.requestWithEndpointFallback)(this.connection, {
                    method: 'POST',
