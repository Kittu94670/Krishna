...
const webApplicationsSourceAdapter_1 = require("./webApplicationsSourceAdapter");
    ...
    getAdapter(type, forceIgnore = new forceIgnore_1.ForceIgnore()) {
        ...
        switch (adapterId) {
            ...
            case 'webApplications':
                return new webApplicationsSourceAdapter_1.WebApplicationsSourceAdapter(type, this.registry, forceIgnore, this.tree);
