...
class ForceIgnore {
    ...
    denies(fsPath) {
        ...
        try {
            ...
            const res = this.parser.ignores((0, node_path_1.relative)(this.forceIgnoreDirectory, absoluteFsPath));
            if (res) {
                logger_1.Logger.childFromRoot('forceIgnore.denies').debug(`Ignoring file '${fsPath}' because it matched .forceignore patterns.`);
            }
            return res;
        }
        catch (e) {
    ...
    accepts(fsPath) {
        ...
        try {
            const absoluteFsPath = (0, node_path_1.isAbsolute)(fsPath) ? fsPath : (0, node_path_1.resolve)(this.forceIgnoreDirectory, fsPath);
            return !this.parser.ignores((0, node_path_1.relative)(this.forceIgnoreDirectory, absoluteFsPath));
        }
        catch (e) {
            return true;
        }
