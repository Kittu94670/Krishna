...
![GIF showing SOQL query builder, viewing query results, and saving results to csv](https://github.com/forcedotcom/salesforcedx-vscode/raw/HEAD/images/SOQL_Builder_50.16.0.gif)
